...
import azure_openai.run_assistant_azure_openai as aoi

cl.instrument_openai()

# client = AsyncOpenAI(api_key=os.environ.get("CE_OPENAI_API_KEY")) # NB default is OPENAI_API_KEY
whisper_client = AsyncOpenAI(api_key=os.environ.get("CE_OPENAI_API_KEY")) # NB default is OPENAI_API_KEY
...
async def run_conversation(user_message: str):
    ...
    go.add_message_to_thread(user_message.content)

    response = await go.run_thread()
...
async def generate_text_answer(transcription, images):
    ...
    # original below replaced with Azure OpenAI Assistants response
